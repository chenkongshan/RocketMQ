    ...
    public boolean initialize() throws CloneNotSupportedException {
        ...
        if (result) {
            ...
            this.sendMessageExecutor = new BrokerFixedThreadPoolExecutor(//
                    this.brokerConfig.getSendMessageThreadPoolNums(),// default 16 + Runtime.getRuntime().availableProcessors() * 4
                    this.brokerConfig.getSendMessageThreadPoolNums(),//
                    1000 * 60,//
                    TimeUnit.MILLISECONDS,//
                    this.sendThreadPoolQueue,//default size 10000
            ...
            //持久化ConcurrentHashMap<String/* topic@group */, ConcurrentHashMap<Integer, Long>> offsetTable
            this.scheduledExecutorService.scheduleAtFixedRate(new Runnable() {
                @Override
                public void run() {
                    try {
            ...
            }, 1000 * 10, this.brokerConfig.getFlushConsumerOffsetInterval()/*1000 * 5*/, TimeUnit.MILLISECONDS);
